                  ...
                  <div key={item.productId} className="bg-white p-3 rounded-xl flex gap-3 shadow-sm border border-gray-100">
                    ...
                    <div className="flex-1 flex flex-col justify-between">
                      ...
                      <div className="flex items-center justify-between mt-2">
                        <span className="font-semibold text-gray-900">₹{formatPrice(item.product.price, item.product.displayPrice)}</span>
            ...
            {cartItems.length > 0 && (
              <div className="bg-white p-4 border-t shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="font-bold text-gray-900">₹{formatTotalPrice(cartItems)}</span>
                </div>
                <button 
                  onClick={onCheckout}
                ...
                >
                  <div className="flex flex-col items-start">
                    ...
                    <span className="text-sm leading-none mt-1 opacity-90">₹{formatTotalPrice(cartItems)}</span>
                  </div>
